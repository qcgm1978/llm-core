...
interface OpenAIPromptsCollection {
...
const defaultPrompts: PromptsCollection = {
  ...
  zh: [
    ...
    { act: '纯文本', prompt: '"{topic}"。不要使用markdown、标题或任何特殊格式。只返回定义本身的文本。' },
    { act: 'wiki', prompt: '请用中文为{category}类别里的术语"{topic}"提供一个简洁、百科全书式的定义。请提供信息丰富且中立的内容。不要使用markdown、标题或任何特殊格式。只返回定义本身的文本。' },
  ...
  en: [
    { act: 'Concise Definition', prompt: 'Please provide a concise, encyclopedia-style definition for the term: "{topic}"...' },
